...
@InputType()
class EmployeesCreateNestedManyWithoutStoresItemsInput {
...
export { EmployeesCreateNestedManyWithoutStoresItemsInput as EmployeesCreateNestedManyWithoutStoresItemsInput };
