...
@InputType()
class PaymentsUpdateManyWithoutAppointmentsItemsInput {
...
export { PaymentsUpdateManyWithoutAppointmentsItemsInput as PaymentsUpdateManyWithoutAppointmentsItemsInput };
